...
class Derived : private Base { // the public, protected, and private members of base class will be inherited as private
protected:
    int derived_prot;
private:
    int derived_priv;
...
int main() {
    ...
    // cout<<"--------------------------------"<<endl;
    Derived d;
    // the following line will cause error -> the base_pub inherited as private
